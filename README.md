# CRC Installer PowerShell 2.0.0

When run you will get a form that allows to select what programs you wish to install.

Can install the CRC OEM information, 7-zip, Google Chrome, Kaspersky Internet Security 2017, LibreOffice, Microsoft DotNet 4.5, Microsoft DotNet 4.6.1, Mozilla Firefox, PowerShell 5, TeamViewer & VLC Media Player.
